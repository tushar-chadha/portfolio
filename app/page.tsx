...
export default function Portfolio() {
  ...
  const apps = [
    ...
    },
    {
      ...
      playStoreLink: "#",
      stats: {},
      tech: ["Flutter Web", "Flutter Mobile", "GoLang", "gRPC", "AWS", "PostgreSQL", "System Migration"],
      features: ["Admin Panels", "Business Dashboards", "Operations Management", "Team Leadership", "AWS Migration", "Legacy System Modernization"],
  ...
  const experiences = [
    ...
    },
    {
      ...
      subProjects: [
        {
          name: "Peace App - Mental Wellness",
          description: "Led all app development as sole mobile engineer. Independently architected and launched full-scale cross-platform mental wellness application. Designed scalable architecture using BLoC + MVVM patterns. Managed complete product lifecycle from requirements gathering to App Store deployment.",
        },
        {
          name: "Maishaa - Business Management Platform",
          description: "Led complete tech stack transformation and team. Developed all internal business management tools (admin panels, dashboards, operational systems) using Flutter Web + Mobile. Led backend team in building GoLang microservices with gRPC. Migrated entire infrastructure from legacy PHP/cPanel to modern Flutter + Go + AWS stack.",
        },
        {
          name: "HiCollege - EdTech Platform",
          description: "Collaborated with cross-functional product team. Worked on mobile app development and product features using Flutter with native iOS enhancements. Synced with design and backend teams to deliver integrated EdTech solutions with REST and gRPC API integrations.",
        }
      ]
    },
    {
                    ...
                    {!app.isInternal ? (
                      ...
                      <div className="flex flex-wrap gap-3">
                        {app.platforms.map((platform, i) => (
                          <div key={i} className="bg-black/30 backdrop-blur px-4 py-2 rounded-lg flex items-center gap-2">
